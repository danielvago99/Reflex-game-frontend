      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          <button
            ...
            className="bg-white/10 backdrop-blur-sm border border-white/10 hover:bg-white/10 hover:border-[#00FFA3]/50 p-3 rounded-xl transition-all"
          >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative bg-white/10 backdrop-blur-sm border border-white/10 shadow-xl overflow-hidden" style={{ clipPath: 'polygon(16px 0, 100% 0, 100% calc(100% - 16px), calc(100% - 16px) 100%, 0 100%, 0 16px)' }}>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            ...
            <div key={i} className="relative group">
              ...
              <div className="relative bg-white/10 backdrop-blur-sm border border-white/10 hover:border-white/20 shadow-lg overflow-hidden transition-all" style={{ clipPath: 'polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)' }}>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative bg-white/10 backdrop-blur-sm border border-white/10 shadow-xl overflow-hidden" style={{ clipPath: 'polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)' }}>
        ...
        <div className="relative mb-6">
          <button
            ...
            className="w-full bg-gradient-to-r from-[#7C3AED]/20 to-[#A855F7]/20 hover:from-[#7C3AED]/30 hover:to-[#A855F7]/30 border border-[#7C3AED]/30 text-white py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
          >
