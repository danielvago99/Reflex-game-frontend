      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center">
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="relative grid grid-cols-2 gap-3">
            <div className="pointer-events-none absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-[#06B6D4]/60 to-transparent shadow-[0_0_12px_rgba(6,182,212,0.6)]"></div>
            <div className="pointer-events-none absolute top-1/2 left-0 h-px w-full -translate-y-1/2 bg-gradient-to-r from-transparent via-[#7C3AED]/70 to-transparent shadow-[0_0_12px_rgba(124,58,237,0.6)]"></div>
            {/* Anti-Cheat */}
            <div className="group relative rounded-xl bg-gradient-to-br from-[#00FFA3]/60 via-[#06B6D4]/35 to-[#00FFA3]/70 p-[1px] shadow-[0_0_18px_rgba(0,255,163,0.35)] transition-all duration-300 hover:shadow-[0_0_26px_rgba(0,255,163,0.55)]">
              <div className="relative overflow-hidden rounded-[11px] border border-white/5 bg-[#05070d]/70 p-3 backdrop-blur-[3px] transition-all duration-300 group-hover:bg-white/5">
                <div className="absolute inset-0 bg-gradient-to-br from-[#00FFA3]/8 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
            ...
            {/* Smart Contract */}
            <div className="group relative rounded-xl bg-gradient-to-br from-[#7C3AED]/70 via-[#06B6D4]/30 to-[#7C3AED]/60 p-[1px] shadow-[0_0_18px_rgba(124,58,237,0.35)] transition-all duration-300 hover:shadow-[0_0_26px_rgba(124,58,237,0.55)]">
              <div className="relative overflow-hidden rounded-[11px] border border-white/5 bg-[#05070d]/70 p-3 backdrop-blur-[3px] transition-all duration-300 group-hover:bg-white/5">
                <div className="absolute inset-0 bg-gradient-to-br from-[#7C3AED]/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <div className="relative flex flex-col items-center gap-1.5 text-center">
            ...
            {/* Practise Mode */}
            <div className="group relative rounded-xl bg-gradient-to-br from-[#00FFA3]/60 via-[#06B6D4]/30 to-[#00FFA3]/70 p-[1px] shadow-[0_0_18px_rgba(0,255,163,0.35)] transition-all duration-300 hover:shadow-[0_0_26px_rgba(0,255,163,0.55)]">
              <div className="relative overflow-hidden rounded-[11px] border border-white/5 bg-[#05070d]/70 p-3 backdrop-blur-[3px] transition-all duration-300 group-hover:bg-white/5">
                <div className="absolute inset-0 bg-gradient-to-br from-[#00FFA3]/8 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <div className="relative flex flex-col items-center gap-1.5 text-center">
                  <div className="rounded-full bg-[#00FFA3]/10 p-1.5 text-[#00FFA3] shadow-[0_0_15px_rgba(0,255,163,0.2)]">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-[#00FFA3] mb-1">Practise Mode</h4>
            ...
            {/* Matchmaking */}
            <div className="group relative rounded-xl bg-gradient-to-br from-[#7C3AED]/70 via-[#06B6D4]/30 to-[#A855F7]/60 p-[1px] shadow-[0_0_18px_rgba(124,58,237,0.35)] transition-all duration-300 hover:shadow-[0_0_26px_rgba(124,58,237,0.55)]">
              <div className="relative overflow-hidden rounded-[11px] border border-white/5 bg-[#05070d]/70 p-3 backdrop-blur-[3px] transition-all duration-300 group-hover:bg-white/5">
                <div className="absolute inset-0 bg-gradient-to-br from-[#7C3AED]/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <div className="relative flex flex-col items-center gap-1.5 text-center">
                  <div className="rounded-full bg-[#7C3AED]/10 p-1.5 text-[#7C3AED] shadow-[0_0_15px_rgba(124,58,237,0.2)]">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-[#7C3AED] mb-1">Fair Matchmaking</h4>
