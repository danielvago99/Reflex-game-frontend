      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center">
        ...
        <div className="w-full max-w-sm flex flex-col gap-3">
          <button
            ...
            className="mx-auto w-full sm:w-full bg-gradient-to-r from-[#00FFA3] via-[#06B6D4] to-[#7C3AED] hover:shadow-[0_0_30px_rgba(0,255,163,0.5)] text-[#0B0F1A] py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="mx-auto w-full rounded-xl border border-white/10 bg-white/5 py-2.5 px-6text-sm text-white/90 shadow-lg transition-all duration-300 hover:border-white/20 hover:bg-white/10 hover:text-white flex items-center justify-center gap-2 mb-2"
          >
