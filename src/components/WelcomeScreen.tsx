      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full">
        ...
        <div className="w-full max-w-sm mx-auto mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Anti-Cheat */}
            <div className="group relative overflow-hidden rounded-xl border border-[#06B6D4] bg-[#05070d]/60 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#00FFA3]/50 hover:bg-white/5">
            ...
            {/* Smart Contract */}
            <div className="group relative overflow-hidden rounded-xl border border-[#06B6D4] bg-[#05070d]/60 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#7C3AED]/50 hover:bg-white/5">
            ...
            {/* Matchmaking */}
            <div className="group relative overflow-hidden rounded-xl border border-[#06B6D4]/10 bg-[#05070d]/60 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#A855F7]/50 hover:bg-white/5">
              <div className="absolute inset-0 bg-gradient-to-br from-[#7C3AED]/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="relative flex flex-col items-center gap-2 text-center">
                <div className="rounded-full bg-[#7C3AED]/10 p-2 text-[#7C3AED] shadow-[0_0_15px_rgba(124,58,237,0.2)]">
