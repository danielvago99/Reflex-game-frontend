...
import { Gamepad2, Key, Play, ShieldCheck, Trophy, UsersRound, Wallet, X, Zap } from 'lucide-react';
      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center">
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Anti-Cheat */}
            <div className="group relative isolate overflow-hidden rounded-xl border border-[#00FFA3]/20 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#00FFA3]/60 hover:bg-white/5">
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#00FFA3]/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-7 right-7 z-10 h-px bg-gradient-to-r from-transparent via-[#00FFA3] to-transparent"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-8 right-8 z-10 h-[3px] bg-gradient-to-r from-transparent via-[#00FFA3]/80 to-transparent blur-[2px]"></div>
              <div className="relative z-20 flex flex-col items-center gap-1.5 text-center">
            ...
            {/* Smart Contract */}
            <div className="group relative isolate overflow-hidden rounded-xl border border-[#7C3AED]/20 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#7C3AED]/60 hover:bg-white/5">
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#7C3AED]/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-7 right-7 z-10 h-px bg-gradient-to-r from-transparent via-[#7C3AED] to-transparent"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-8 right-8 z-10 h-[3px] bg-gradient-to-r from-transparent via-[#7C3AED]/80 to-transparent blur-[2px]"></div>
              <div className="relative z-20 flex flex-col items-center gap-1.5 text-center">
            ...
            {/* Practise Mode */}
            <div className="group relative isolate overflow-hidden rounded-xl border border-[#06B6D4]/20 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-[#06B6D4]/60 hover:bg-white/5">
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#00FFA3]/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-7 right-7 z-10 h-px bg-gradient-to-r from-transparent via-[#06B6D4] to-transparent"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-8 right-8 z-10 h-[3px] bg-gradient-to-r from-transparent via-[#06B6D4]/80 to-transparent blur-[2px]"></div>
              <div className="relative z-20 flex flex-col items-center gap-1.5 text-center">
            ...
            {/* Matchmaking */}
            <div className="group relative isolate overflow-hidden rounded-xl border border-fuchsia-400/20 p-3 backdrop-blur-[3px] transition-all duration-300 hover:border-fuchsia-400/60 hover:bg-white/5">
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#ca33f8]/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-7 right-7 z-10 h-px bg-gradient-to-r from-transparent via-fuchsia-400 to-transparent"></div>
              <div className="pointer-events-none absolute bottom-[3px] left-8 right-8 z-10 h-[3px] bg-gradient-to-r from-transparent via-fuchsia-400/80 to-transparent blur-[2px]"></div>
              <div className="relative z-20 flex flex-col items-center gap-1.5 text-center">
