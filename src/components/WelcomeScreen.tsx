      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center">
        ...
        <div className="w-full max-w-xs flex flex-col gap-3">
          ...
          <button
            ...
            className="mx-auto w-55 rounded-lg border border-white/10 bg-white/5 py-1.5 px-6 text-xs text-white/90 shadow-lg transition-all duration-300 hover:border-white/20 hover:bg-white/10 hover:text-white flex items-center justify-center gap-2 mb-2"
          >
