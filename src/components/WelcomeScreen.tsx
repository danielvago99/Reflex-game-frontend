      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full">
        ...
        <div className="w-full space-y-3 max-w-xs mx-auto">
          <button
            ...
            className="w-full bg-gradient-to-r from-[#00FFA3] to-[#06B6D4] backdrop-blur-md hover:shadow-[0_0_30px_rgba(0,255,163,0.5)] text-[#0B0F1A] py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2"
          >
