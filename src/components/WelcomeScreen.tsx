    ...
    <div className="h-screen-dvh bg-gradient-to-br from-[#0B0F1A] via-[#101522] to-[#1a0f2e] flex flex-col items-center justify-center p-3 xs:p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full">
        ...
        <div className="relative mb-8 max-w-sm mx-auto">
          ...
          <div className="glass-panel shadow-xl" style={{ clipPath: 'polygon(16px 0, 100% 0, 100% calc(100% - 16px), calc(100% - 16px) 100%, 0 100%, 0 16px)' }}>
            {/* Top accent line */}
        ...
        <div className="grid grid-cols-3 gap-3 mb-8 w-full max-w-sm mx-auto">
          <div className="glass-panel rounded-xl p-3 flex flex-col items-center gap-2 border-[#00FFA3]/30">
            <Target className="w-6 h-6 text-[#00FFA3]" strokeWidth={2} />
            <span className="text-xs text-gray-400">Quick Reflexes</span>
          </div>
          <div className="glass-panel rounded-xl p-3 flex flex-col items-center gap-2 border-[#06B6D4]/30">
            <Timer className="w-6 h-6 text-[#06B6D4]" strokeWidth={2} />
            <span className="text-xs text-gray-400">Real-time</span>
          </div>
          <div className="glass-panel rounded-xl p-3 flex flex-col items-center gap-2 border-[#7C3AED]/30">
        ...
        <div className="w-full space-y-3 max-w-xs mx-auto">
          <button
            ...
            className="glass-button w-full bg-gradient-to-r from-[#00FFA3] to-[#06B6D4] hover:shadow-[0_0_30px_rgba(0,255,163,0.5)] text-[#0B0F1A] py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="glass-button w-full bg-white/5 hover:bg-white/10 border border-[#00FFA3]/30 hover:border-[#00FFA3]/60 hover:shadow-[0_0_20px_rgba(0,255,163,0.3)] text-white py-3 rounded-xl transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="glass-button w-full bg-white/5 text-[#00FFA3] hover:text-[#06B6D4] py-2 text-center text-sm transition-all flex items-center justify-center gap-2"
          >
