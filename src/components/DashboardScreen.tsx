      ...
      <div className="relative z-10 max-w-md mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-[#0B0F1A] via-[#1a0f2e] to-[#0B0F1A] border-2 border-[#00FFA3]/50 rounded-2xl overflow-hidden">
            ...
            <div className="relative p-5">
              ...
              <div className="relative">
                ...
                <div className="glass-panel rounded-xl p-4 border-[#00FFA3]/30">
                  ...
                  <div className="relative">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      >
                        ...
                        <div className="glass-button relative bg-white/10 hover:bg-white/20 border border-[#00FFA3]/30 hover:border-[#00FFA3]/60 text-white px-3 py-2 rounded-lg transition-all flex items-center justify-center gap-2">
                      ...
                      >
                        ...
                        <div className="glass-button relative bg-white/10 hover:bg-white/20 border border-[#06B6D4]/30 hover:border-[#06B6D4]/60 text-white px-3 py-2 rounded-lg transition-all flex items-center justify-center gap-2">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="glass-button w-full overflow-hidden p-5 rounded-xl transition-all duration-300 transform hover:scale-[1.03] group"
          >
          ...
          <button
            ...
            className="glass-button w-full bg-white/5 border border-[#7C3AED]/30 hover:bg-white/10 hover:border-[#7C3AED]/60 hover:shadow-[0_0_20px_rgba(124,58,237,0.3)] text-white p-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="glass-button w-full overflow-hidden p-4 rounded-xl transition-all duration-300 group"
          >
            {/* Animated gradient background */}
          ...
          <button
            ...
            className="glass-button w-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#06B6D4]/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] text-white p-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="glass-button w-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] text-white p-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
          >
        ...
        <div className="relative">
          ...
          <div className="glass-panel shadow-lg" style={{ clipPath: 'polygon(0 8px, 8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%)' }}>
            {/* Top decorative line */}
                  ...
                  <div className="relative">
                    <div className="glass-panel rounded-lg p-8 text-center">
                      ...
                      <div className="relative">
                        ...
                        <button
                          onClick={() => onNavigate('lobby')}
                          className="glass-button mx-auto bg-gradient-to-r from-[#00FFA3]/20 to-[#06B6D4]/20 hover:from-[#00FFA3]/30 hover:to-[#06B6D4]/30 border border-[#00FFA3]/30 text-[#00FFA3] py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
                        >
