...
const envSchema = z.object({
  ...
  FREE_STAKE_DAILY_BUDGET_LAMPORTS: z.coerce.number().int().nonnegative().default(2000000000),
  FREE_STAKE_MAX_PER_MATCH_LAMPORTS: z.coerce.number().int().nonnegative().default(200000000),
  FREE_STAKE_MAX_MATCHES_PER_USER_PER_DAY: z.coerce.number().int().default(3),
  FREE_STAKE_MAX_LAMPORTS_PER_USER_PER_DAY: z.coerce.number().int().nonnegative().default(500000000),
